...
import { getEnumValues, randInt } from "#app/utils";
...
// to make typescript happy for the moment
let biomePokemonPools;
let biomeTrainerPools;
...
export const biomes: BiomeData = {
  ...
  [Biome.GRASS]: {
    biomeLinks: [[Biome.TALL_GRASS, 100]],
    biomeSpeciesPools: {
      [BiomePoolTier.COMMON]: {
        [TimeOfDay.DAWN]: [
  ...
  [Biome.LABORATORY]: {
    biomeLinks: [[Biome.CONSTRUCTION_SITE, 100]],
    biomeSpeciesPools: {
      [BiomePoolTier.COMMON]: {
        [TimeOfDay.DAWN]: [],
        [TimeOfDay.DAY]: [],
  ...
  [Biome.ICE_CAVE]: {
    biomeLinks: [[Biome.SNOWY_FOREST, 100]],
    biomeSpeciesPools: {
      [BiomePoolTier.COMMON]: {
        [TimeOfDay.DAWN]: [],
        [TimeOfDay.DAY]: [],
