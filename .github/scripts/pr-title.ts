...
const PREFIXES = [
  ...
  "dev", // Improving the developer experience (such as by modifying lint rules)
  "docs", // Primarily adding/updating documentation
  "feat", // Adding a new feature (e.g. adding a new implementation of a move)
  "fix", // Fixing a bug
  ...
  "refactor", // A change that doesn't impact functionality or fix any bugs
